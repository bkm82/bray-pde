...
#+ATTR_LATEX: :options frame=single
#+BEGIN_SRC python :results graphics file :file transient_temperature_profile.png :exports both :session Python-Session
  #plotter(data_list = transient_list, mesh = transient_mesh, name = "transient")
  part3_plotter= Plotter(mesh = transient_mesh)
  part3_plotter.transient_plotter(
      data_list = transient_list,
      name = "transient")
#+END_SRC
